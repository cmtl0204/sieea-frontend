import{Ba as q,sa as E,ta as N,ya as O}from"./chunk-BBXWWWUQ.js";import{Ab as k,Bb as I,Fb as l,Gb as x,Hb as M,Hc as S,Jb as d,Jc as z,Lb as f,Lc as B,Mb as m,Oc as Q,P as _,Qa as o,Qb as w,Rb as D,V as v,Xb as F,bb as h,fa as g,fb as T,gb as r,ob as i,qc as j,rb as b,sb as C,xb as p,yb as u,zb as $}from"./chunk-BXX64NYW.js";var P=["icon"],R=["*"];function V(e,c){if(e&1&&$(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function H(e,c){if(e&1&&(k(0),r(1,V,1,1,"span",3),I()),e&2){let t=l();o(),i("ngIf",t.icon)}}function G(e,c){}function J(e,c){e&1&&r(0,G,0,0,"ng-template")}function K(e,c){if(e&1&&(p(0,"span",5),r(1,J,1,0,null,6),u()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var L=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;

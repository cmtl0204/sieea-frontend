...
export class StateComponent implements OnInit {
    ...
    ngOnInit() {
        this.findStatesByAdditionalInformation();
    }

    findStatesByAdditionalInformation() {
        this.stateHttpService.findStatesByAdditionalInformation(this._authService.additionalInformation.id).subscribe({
            next: (response) => {

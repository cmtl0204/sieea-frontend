...
export class ActivityHttpService {
    ...
    private readonly _apiUrl = `${environment.API_URL}/activities`;
    private readonly _customMessageService = inject(CustomMessageService);

    findActivitiesByAdditionalInformation(additionalInformationId: string): Observable<ActivityInterface[]> {
